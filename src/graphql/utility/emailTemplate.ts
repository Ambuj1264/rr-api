    ...
    <body style="font-family: 'Trebuchet MS', sans-serif; font-size: 12px !important;">
      <div class="main-content">
        ...
        <strong>
          ...
          <a href=https://resource-reservation-admin.hacked.com/reset-password/${token} class="reset-button">Change Password</a>
        </strong>
        <br>
        <br>
        <h4 style="color: #0277B6;">ANY QUESTIONS? EMAIL US: <a style="color: #B1F48E; font-weight: normal;" href="mailto: test@hacked.com">test@hacked.com</a></h4>
        <br>
      </div>
    </body>
    </html>
